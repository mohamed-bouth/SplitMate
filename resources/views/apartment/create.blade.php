            ...
            <div class="bg-[#1e1f22] overflow-hidden shadow-xl sm:rounded-2xl border border-gray-800">
                <div class="p-8">
                    ...
                    <div class="mb-8 border-b border-gray-800 pb-6">
                        <h2 class="text-2xl font-bold text-white mb-2">Create New Space 🏠</h2>
                        <p class="text-gray-400 text-sm">Set up a new apartment to start splitting expenses with your roommates.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('apartment.store') }}">
                        ...
                        <div>
                            <label for="name" class="block font-medium text-sm text-gray-300 mb-2">{{ __('Apartment Name') }}</label>
                        ...
                        <div class="mt-8 flex items-center justify-end">
                            <a href="{{ route('dashboard') }}" class="py-3.5 px-6 rounded-xl text-sm font-medium text-gray-400 hover:text-white transition-colors mr-4">
                                Cancel
                            </a>
