            ...
            <div class="bg-[#1e1f22] overflow-hidden shadow-xl sm:rounded-2xl border border-gray-800">
                <div class="p-8">
                    ...
                    <div class="mb-8 border-b border-gray-800 pb-6">
                        <h2 class="text-2xl font-bold text-white mb-2">Edit Category ✏️</h2>
                        <p class="text-gray-400 text-sm">Update your category name to keep your expenses organized.</p>
                    </div>
